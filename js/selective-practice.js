...
function updateHeader(){
 ...
 $('mode6').textContent=isThinking?'Challenge Thinking':isReading?'Reading Challenge':'Year 6 Challenge';
 ...
 $('practiceSub').textContent=isThinking?'Question styles include conditional logic, strongest conclusion, ordering, seating, time, number reasoning, data, probability and arguments.':isReading?'Practise paired texts, inference, vocabulary, purpose, poetry, sequence, sentence placement and multiple-extract matching.':'Practise one topic at a time with a short hint after each question.';
